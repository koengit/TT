...
%fof( a ,question, (?[Vf]: ~((![Vx]: (pChild(Vx) => pget(Vx,sp_ap(Vf,Vx)))) => (?[Vy]: (pChild(Vy) & popens(Vy,sp_ap(Vf,Vy)))))) ).
fof( a ,axiom, ( ((![Vx]: (pChild(Vx) => pget(Vx,sp_ap(override(const(pyssel),vincent,piano),Vx)))) => (?[Vy]: (pChild(Vy) & popens(Vy,sp_ap(override(const(pyssel),vincent,piano),Vy)))))) ).
fof( a ,axiom, ( ((![Vx]: (pChild(Vx) => pget(Vx,sp_ap(const(pyssel),Vx)))) => (?[Vy]: (pChild(Vy) & popens(Vy,sp_ap(const(pyssel),Vy))))))).
